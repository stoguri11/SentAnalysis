...
from loadmodel import make_predictions
from sentiment_analysis import prepare_data
from BOW import bow

# loading dataset 
# dataset from http://help.sentiment140.com/for-students/
with open("data/predictions.csv", encoding='utf-8') as training_data:
    ...
    # Train classifier
    predict = make_predictions(prepared_data)
